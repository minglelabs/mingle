    ...
    return (
      ...
      >
        ...
        <section
          ...
          className="h-[47svh] max-h-[30rem] min-h-[21rem] shrink-0 rounded-t-[2rem] bg-[#1C1C1E] px-5 pb-[calc(1.05rem+env(safe-area-inset-bottom))] pt-4"
        >
          {isLoading ? (
            ...
            >
              ...
              >
                <div className="w-1/2 shrink-0 pt-10">
                ...
                <div className="w-1/2 shrink-0 pl-4 pt-10">
