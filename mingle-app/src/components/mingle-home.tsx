    ...
    <main className="h-full min-h-0 w-full overflow-hidden bg-white text-slate-900">
      {isLiveDemoMounted ? (
        <LivePhoneDemo
          ...
          sttSegmentationModeLabel={props.dictionary.demo.sttSegmentationModeLabel}
          sttSegmentationModeEndLabel={props.dictionary.demo.sttSegmentationModeEndLabel}
          sttSegmentationModeFinLabel={props.dictionary.demo.sttSegmentationModeFinLabel}
          endpointTuningLabel={props.dictionary.demo.endpointTuningLabel}
