...
const ROOM_MANAGEMENT_COPY_BY_LOCALE = {
  ko: {
    ...
    shareToggleDescription: '켜면 누구나 링크로 이 대화방을 보고 참여할 수 있어요.',
  ...
  en: {
    ...
    shareToggleDescription: 'When on, anyone with the link can view this conversation and join it.',
  ...
  ja: {
    ...
    shareToggleDescription: 'オンにすると、リンクを知っている人なら誰でもこの会話を見て参加できます。',
  ...
  'zh-CN': {
    ...
    shareToggleDescription: '开启后，任何拥有链接的人都可以查看并加入此会话。',
  ...
  'zh-TW': {
    ...
    shareToggleDescription: '開啟後，任何擁有連結的人都可以查看並加入此對話。',
  ...
  fr: {
    ...
    shareToggleDescription: 'Une fois activé, toute personne disposant du lien peut voir cette conversation et la rejoindre.',
  ...
  de: {
    ...
    shareToggleDescription: 'Wenn aktiviert, kann jeder mit dem Link diese Unterhaltung ansehen und daran teilnehmen.',
  ...
  es: {
    ...
    shareToggleDescription: 'Al activarlo, cualquiera con el enlace podrá ver esta conversación y unirse a ella.',
  ...
  pt: {
    ...
    shareToggleDescription: 'Quando ativado, qualquer pessoa com o link pode ver esta conversa e entrar nela.',
  ...
  it: {
    ...
    shareToggleDescription: 'Se attivo, chiunque abbia il link può vedere questa conversazione e partecipare.',
  ...
  ru: {
    ...
    shareToggleDescription: 'Если включено, любой, у кого есть ссылка, сможет просматривать этот разговор и присоединиться к нему.',
  ...
  ar: {
    ...
    shareToggleDescription: 'عند التفعيل، يمكن لأي شخص لديه الرابط عرض هذه المحادثة والانضمام إليها.',
  ...
  hi: {
    ...
    shareToggleDescription: 'चालू करने पर, लिंक रखने वाला कोई भी व्यक्ति इस बातचीत को देख सकता है और इसमें शामिल हो सकता है।',
  ...
  th: {
    ...
    shareToggleDescription: 'เมื่อเปิดใช้ ใครก็ตามที่มีลิงก์จะดูและเข้าร่วมบทสนทนานี้ได้',
  ...
  vi: {
    ...
    shareToggleDescription: 'Khi bật, bất kỳ ai có liên kết đều có thể xem và tham gia cuộc trò chuyện này.',
