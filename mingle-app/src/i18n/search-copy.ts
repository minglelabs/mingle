...
export type SearchCopy = {
  ...
  /** Accessible label for the back button of the full people list screen. */
  back: string
  ...
  follow: string
  following: string
  /** Error shown when a follow toggle fails. */
  followError: string
...
const copy: Record<LegalDocumentLocale, SearchCopy> = {
  ...
  de: {
    ...
    follow: 'Folgen',
    following: 'Gefolgt',
    followError: 'Folgen-Status konnte nicht aktualisiert werden.',
  ...
  pt: {
    ...
    follow: 'Seguir',
    following: 'Seguindo',
    followError: 'Não foi possível atualizar o status de seguir.',
  ...
  it: {
    ...
    follow: 'Segui',
    following: 'Seguìto',
    followError: 'Impossibile aggiornare lo stato di seguito.',
  ...
  th: {
    ...
    followError: 'ไม่สามารถอัปเดตสถานะการติดตามได้',
