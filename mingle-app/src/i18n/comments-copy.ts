...
export type CommentsCopy = {
  ...
  // Replies
  viewReplies: string // "{n}" — the plural "other" form
  /**
   * Other plural forms of viewReplies, keyed by `Intl.PluralRules` category.
   * Languages without number inflection (ko, ja, zh, th, vi, hi) leave it empty.
   */
  viewRepliesForms: Partial<Record<'zero' | 'one' | 'two' | 'few' | 'many', string>>
  hideReplies: string
  ...
  unlike: string
  likeCount: string // "{n}"
  likeWithCount: string // "{n}" — accessible name of the like button (not liked yet)
  unlikeWithCount: string // "{n}" — accessible name of the like button (liked)
  reply: string
  edit: string
  delete: string
  report: string
...
const copy: Record<LegalDocumentLocale, CommentsCopy> = {
  ko: {
    ...
    viewReplies: '답글 {n}개 보기', hideReplies: '답글 숨기기', replyToUser: '@{name}', viewRepliesForms: {},
    like: '좋아요', unlike: '좋아요 취소', likeCount: '{n}', likeWithCount: '좋아요, {n}개', unlikeWithCount: '좋아요 취소, {n}개', reply: '답글', edit: '수정', delete: '삭제', report: '신고', save: '저장', cancel: '취소', more: '더 보기', deleteConfirm: '이 댓글을 삭제할까요?', deleteConfirmYes: '삭제', deletedPlaceholder: '삭제된 댓글입니다.', edited: '(수정됨)', actionFailed: '처리하지 못했습니다. 다시 시도해 주세요.',
  ...
  en: {
    ...
    viewReplies: 'View {n} replies', hideReplies: 'Hide replies', replyToUser: '@{name}', viewRepliesForms: { one: 'View {n} reply' },
    like: 'Like', unlike: 'Unlike', likeCount: '{n}', likeWithCount: 'Like, {n} likes', unlikeWithCount: 'Unlike, {n} likes', reply: 'Reply', edit: 'Edit', delete: 'Delete', report: 'Report', save: 'Save', cancel: 'Cancel', more: 'More', deleteConfirm: 'Delete this comment?', deleteConfirmYes: 'Delete', deletedPlaceholder: 'This comment was deleted.', edited: '(edited)', actionFailed: 'Something went wrong. Please try again.',
  ...
  ja: {
    ...
    viewReplies: '返信{n}件を表示', hideReplies: '返信を非表示', replyToUser: '@{name}', viewRepliesForms: {},
    like: 'いいね', unlike: 'いいねを取り消す', likeCount: '{n}', likeWithCount: 'いいね、{n}件', unlikeWithCount: 'いいねを取り消す、{n}件', reply: '返信', edit: '編集', delete: '削除', report: '報告', save: '保存', cancel: 'キャンセル', more: 'その他', deleteConfirm: 'このコメントを削除しますか？', deleteConfirmYes: '削除', deletedPlaceholder: '削除されたコメントです。', edited: '（編集済み）', actionFailed: '処理できませんでした。もう一度お試しください。',
  ...
  'zh-CN': {
    ...
    viewReplies: '查看 {n} 条回复', hideReplies: '隐藏回复', replyToUser: '@{name}', viewRepliesForms: {},
    like: '赞', unlike: '取消赞', likeCount: '{n}', likeWithCount: '赞，{n} 个赞', unlikeWithCount: '取消赞，{n} 个赞', reply: '回复', edit: '编辑', delete: '删除', report: '举报', save: '保存', cancel: '取消', more: '更多', deleteConfirm: '要删除这条评论吗？', deleteConfirmYes: '删除', deletedPlaceholder: '该评论已删除。', edited: '（已编辑）', actionFailed: '操作失败，请重试。',
  ...
  'zh-TW': {
    ...
    viewReplies: '查看 {n} 則回覆', hideReplies: '隱藏回覆', replyToUser: '@{name}', viewRepliesForms: {},
    like: '讚', unlike: '取消讚', likeCount: '{n}', likeWithCount: '讚，{n} 個讚', unlikeWithCount: '取消讚，{n} 個讚', reply: '回覆', edit: '編輯', delete: '刪除', report: '檢舉', save: '儲存', cancel: '取消', more: '更多', deleteConfirm: '要刪除這則留言嗎？', deleteConfirmYes: '刪除', deletedPlaceholder: '此留言已刪除。', edited: '（已編輯）', actionFailed: '操作失敗，請重試。',
  ...
  fr: {
    ...
    viewReplies: 'Voir {n} réponses', hideReplies: 'Masquer les réponses', replyToUser: '@{name}', viewRepliesForms: { one: 'Voir {n} réponse' },
    like: 'J’aime', unlike: 'Je n’aime plus', likeCount: '{n}', likeWithCount: 'J’aime, {n} mentions J’aime', unlikeWithCount: 'Je n’aime plus, {n} mentions J’aime', reply: 'Répondre', edit: 'Modifier', delete: 'Supprimer', report: 'Signaler', save: 'Enregistrer', cancel: 'Annuler', more: 'Plus', deleteConfirm: 'Supprimer ce commentaire ?', deleteConfirmYes: 'Supprimer', deletedPlaceholder: 'Ce commentaire a été supprimé.', edited: '(modifié)', actionFailed: 'Une erreur est survenue. Veuillez réessayer.',
  ...
  de: {
    ...
    viewReplies: '{n} Antworten ansehen', hideReplies: 'Antworten ausblenden', replyToUser: '@{name}', viewRepliesForms: { one: '{n} Antwort ansehen' },
    like: 'Gefällt mir', unlike: 'Gefällt mir nicht mehr', likeCount: '{n}', likeWithCount: 'Gefällt mir, {n} Likes', unlikeWithCount: 'Gefällt mir nicht mehr, {n} Likes', reply: 'Antworten', edit: 'Bearbeiten', delete: 'Löschen', report: 'Melden', save: 'Speichern', cancel: 'Abbrechen', more: 'Mehr', deleteConfirm: 'Diesen Kommentar löschen?', deleteConfirmYes: 'Löschen', deletedPlaceholder: 'Dieser Kommentar wurde gelöscht.', edited: '(bearbeitet)', actionFailed: 'Etwas ist schiefgelaufen. Bitte erneut versuchen.',
  ...
  es: {
    ...
    viewReplies: 'Ver {n} respuestas', hideReplies: 'Ocultar respuestas', replyToUser: '@{name}', viewRepliesForms: { one: 'Ver {n} respuesta' },
    like: 'Me gusta', unlike: 'Ya no me gusta', likeCount: '{n}', likeWithCount: 'Me gusta, {n} me gusta', unlikeWithCount: 'Ya no me gusta, {n} me gusta', reply: 'Responder', edit: 'Editar', delete: 'Eliminar', report: 'Denunciar', save: 'Guardar', cancel: 'Cancelar', more: 'Más', deleteConfirm: '¿Eliminar este comentario?', deleteConfirmYes: 'Eliminar', deletedPlaceholder: 'Este comentario se eliminó.', edited: '(editado)', actionFailed: 'Algo salió mal. Inténtalo de nuevo.',
  ...
  pt: {
    ...
    viewReplies: 'Ver {n} respostas', hideReplies: 'Ocultar respostas', replyToUser: '@{name}', viewRepliesForms: { one: 'Ver {n} resposta' },
    like: 'Curtir', unlike: 'Descurtir', likeCount: '{n}', likeWithCount: 'Curtir, {n} curtidas', unlikeWithCount: 'Descurtir, {n} curtidas', reply: 'Responder', edit: 'Editar', delete: 'Excluir', report: 'Denunciar', save: 'Salvar', cancel: 'Cancelar', more: 'Mais', deleteConfirm: 'Excluir este comentário?', deleteConfirmYes: 'Excluir', deletedPlaceholder: 'Este comentário foi excluído.', edited: '(editado)', actionFailed: 'Algo deu errado. Tente novamente.',
  ...
  it: {
    ...
    viewReplies: 'Vedi {n} risposte', hideReplies: 'Nascondi risposte', replyToUser: '@{name}', viewRepliesForms: { one: 'Vedi {n} risposta' },
    like: 'Mi piace', unlike: 'Non mi piace più', likeCount: '{n}', likeWithCount: 'Mi piace, {n} mi piace', unlikeWithCount: 'Non mi piace più, {n} mi piace', reply: 'Rispondi', edit: 'Modifica', delete: 'Elimina', report: 'Segnala', save: 'Salva', cancel: 'Annulla', more: 'Altro', deleteConfirm: 'Eliminare questo commento?', deleteConfirmYes: 'Elimina', deletedPlaceholder: 'Questo commento è stato eliminato.', edited: '(modificato)', actionFailed: 'Qualcosa è andato storto. Riprova.',
  ...
  ru: {
    ...
    viewReplies: 'Показать {n} ответов', hideReplies: 'Скрыть ответы', replyToUser: '@{name}', viewRepliesForms: { one: 'Показать {n} ответ', few: 'Показать {n} ответа', many: 'Показать {n} ответов' },
    like: 'Нравится', unlike: 'Убрать отметку', likeCount: '{n}', likeWithCount: 'Нравится, отметок: {n}', unlikeWithCount: 'Убрать отметку, отметок: {n}', reply: 'Ответить', edit: 'Изменить', delete: 'Удалить', report: 'Пожаловаться', save: 'Сохранить', cancel: 'Отмена', more: 'Ещё', deleteConfirm: 'Удалить этот комментарий?', deleteConfirmYes: 'Удалить', deletedPlaceholder: 'Комментарий удалён.', edited: '(изменено)', actionFailed: 'Что-то пошло не так. Повторите попытку.',
  ...
  ar: {
    ...
    viewReplies: 'عرض {n} رد', hideReplies: 'إخفاء الردود', replyToUser: '@{name}', viewRepliesForms: { one: 'عرض رد واحد', two: 'عرض ردّين', few: 'عرض {n} ردود', many: 'عرض {n} ردًا' },
    like: 'إعجاب', unlike: 'إلغاء الإعجاب', likeCount: '{n}', likeWithCount: 'إعجاب، {n} إعجاب', unlikeWithCount: 'إلغاء الإعجاب، {n} إعجاب', reply: 'رد', edit: 'تعديل', delete: 'حذف', report: 'إبلاغ', save: 'حفظ', cancel: 'إلغاء', more: 'المزيد', deleteConfirm: 'حذف هذا التعليق؟', deleteConfirmYes: 'حذف', deletedPlaceholder: 'تم حذف هذا التعليق.', edited: '(معدّل)', actionFailed: 'حدث خطأ ما. حاول مرة أخرى.',
  ...
  hi: {
    ...
    viewReplies: '{n} उत्तर देखें', hideReplies: 'उत्तर छिपाएँ', replyToUser: '@{name}', viewRepliesForms: {},
    like: 'पसंद', unlike: 'नापसंद', likeCount: '{n}', likeWithCount: 'पसंद, {n} पसंद', unlikeWithCount: 'नापसंद, {n} पसंद', reply: 'उत्तर', edit: 'संपादित करें', delete: 'हटाएँ', report: 'रिपोर्ट करें', save: 'सहेजें', cancel: 'रद्द करें', more: 'और', deleteConfirm: 'यह टिप्पणी हटाएँ?', deleteConfirmYes: 'हटाएँ', deletedPlaceholder: 'यह टिप्पणी हटा दी गई है।', edited: '(संपादित)', actionFailed: 'कुछ गलत हुआ। कृपया पुनः प्रयास करें।',
  ...
  th: {
    ...
    viewReplies: 'ดูการตอบกลับ {n} รายการ', hideReplies: 'ซ่อนการตอบกลับ', replyToUser: '@{name}', viewRepliesForms: {},
    like: 'ถูกใจ', unlike: 'เลิกถูกใจ', likeCount: '{n}', likeWithCount: 'ถูกใจ, {n} ครั้ง', unlikeWithCount: 'เลิกถูกใจ, {n} ครั้ง', reply: 'ตอบกลับ', edit: 'แก้ไข', delete: 'ลบ', report: 'รายงาน', save: 'บันทึก', cancel: 'ยกเลิก', more: 'เพิ่มเติม', deleteConfirm: 'ลบความคิดเห็นนี้ไหม?', deleteConfirmYes: 'ลบ', deletedPlaceholder: 'ความคิดเห็นนี้ถูกลบแล้ว', edited: '(แก้ไขแล้ว)', actionFailed: 'เกิดข้อผิดพลาด โปรดลองอีกครั้ง',
  ...
  vi: {
    ...
    viewReplies: 'Xem {n} câu trả lời', hideReplies: 'Ẩn câu trả lời', replyToUser: '@{name}', viewRepliesForms: {},
    like: 'Thích', unlike: 'Bỏ thích', likeCount: '{n}', likeWithCount: 'Thích, {n} lượt thích', unlikeWithCount: 'Bỏ thích, {n} lượt thích', reply: 'Trả lời', edit: 'Chỉnh sửa', delete: 'Xóa', report: 'Báo cáo', save: 'Lưu', cancel: 'Hủy', more: 'Thêm', deleteConfirm: 'Xóa bình luận này?', deleteConfirmYes: 'Xóa', deletedPlaceholder: 'Bình luận này đã bị xóa.', edited: '(đã chỉnh sửa)', actionFailed: 'Đã xảy ra lỗi. Vui lòng thử lại.',
...
function resolveCopyLocale(locale: string): LegalDocumentLocale {
  return resolveLegalDocumentLocale(resolveSupportedLocaleTag(locale) || 'en')
}
...
/**
 * "View {n} replies" with the language's plural form ("View 1 reply",
 * "Показать 3 ответа"), chosen by `Intl.PluralRules`.
 */
export function formatViewReplies(locale: string, n: number): string {
  const resolved = resolveCopyLocale(locale)
  const c = copy[resolved]
  let category: Intl.LDMLPluralRule = 'other'
  try {
    category = new Intl.PluralRules(resolved).select(n)
  } catch {
    /* keep "other" */
  }
  const template = category === 'other' ? c.viewReplies : c.viewRepliesForms[category] ?? c.viewReplies
  return formatCommentsCopy(template, { n })
}
