...
export type MingleBehaviorProfile = 'legacy_1_0_11' | 'v1_1_0' | 'v1_1_1' | 'v1_1_2' | 'v1_1_3'
...
export function resolveMingleReleaseTarget(rawReleaseTarget: string): MingleReleaseTarget {
  ...
  if (normalizedReleaseTarget === 'v1_1_4') {
    return 'v1_1_4'
  }
...
export function resolveDefaultMingleClientReleaseVariant(): MingleClientReleaseVariant {
  ...
  if (releaseTarget === 'v1_1_3' || releaseTarget === 'v1_1_4' || releaseTarget === 'v2_0_0') {
