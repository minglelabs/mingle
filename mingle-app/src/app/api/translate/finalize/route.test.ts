...
describe('/api/translate/finalize route', () => {
  ...
  it.each([
    ...
    {
      label: 'Android v1.0.13',
      loadRoute: () => import('@/app/api/android/v1.0.13/translate/finalize/route'),
      url: 'http://localhost:3000/api/android/v1.0.13/translate/finalize',
    },
    {
      label: 'iOS v1.0.6',
    ...
    {
      label: 'iOS v1.0.13',
      loadRoute: () => import('@/app/api/ios/v1.0.13/translate/finalize/route'),
      url: 'http://localhost:3000/api/ios/v1.0.13/translate/finalize',
    },
