...
import { POST as postAndroidV110LogClientEvent } from '@/app/api/android/v1.1.0/log/client-event/route'
...
import { POST as postAndroidV110TranslateFinalize } from '@/app/api/android/v1.1.0/translate/finalize/route'
...
import { POST as postAndroidV110TtsInworld } from '@/app/api/android/v1.1.0/tts/inworld/route'
import {
  GET as getAndroidV110Conversations,
  POST as postAndroidV110Conversations,
} from '@/app/api/android/v1.1.0/conversations/route'
import { PATCH as patchAndroidV110Conversation } from '@/app/api/android/v1.1.0/conversations/[conversationId]/route'
...
import { POST as postIosV110LogClientEvent } from '@/app/api/ios/v1.1.0/log/client-event/route'
...
import { POST as postIosV110TranslateFinalize } from '@/app/api/ios/v1.1.0/translate/finalize/route'
...
import { POST as postIosV110TtsInworld } from '@/app/api/ios/v1.1.0/tts/inworld/route'
import {
  GET as getIosV110Conversations,
  POST as postIosV110Conversations,
} from '@/app/api/ios/v1.1.0/conversations/route'
import { PATCH as patchIosV110Conversation } from '@/app/api/ios/v1.1.0/conversations/[conversationId]/route'
...
describe('mingle-app namespace route wiring', () => {
  ...
  it('maps /android/v1.1.0 routes to Android v1.1.0 controllers', () => {
    expect(postAndroidV110TranslateFinalize).toBe(postTranslateFinalizeForAndroidV1_1_0)
  ...
  it('maps /ios/v1.1.0 routes to iOS v1.1.0 controllers', () => {
    expect(postIosV110TranslateFinalize).toBe(postTranslateFinalizeForIosV1_1_0)
