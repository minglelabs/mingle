...
- `NEXT_PUBLIC_WS_URL`
- `NEXT_PUBLIC_API_NAMESPACE` (iOS: `ios/v1.0.5`, Android: `android/v1.0.5`)
...
`pnpm rn:ios` validates `NEXT_PUBLIC_API_NAMESPACE=ios/v1.0.5` before launch.
...
- iOS: `/api/ios/v1.0.5/client/version-policy`
