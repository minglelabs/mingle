...
2. Sends the finalized transcript to `/api/translate/finalize` (or `/api/ios/v1.1.0/translate/finalize`)
...
- Allowed values: `''`, `ios/v1.0.0`, `android/v1.0.0`, `ios/v1.0.2`, `android/v1.0.2`, `ios/v1.0.3`, `android/v1.0.3`, `ios/v1.0.4`, `android/v1.0.4`, `ios/v1.0.5`, `android/v1.0.5`, `ios/v1.1.0`, `android/v1.1.0`
