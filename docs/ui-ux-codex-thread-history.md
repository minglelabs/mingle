...
- `2026-04-17-xr-hero-realtime-interpreter-messenger` | XR hero positioning changed from the broader "social translator" framing to "real-time interpretation messenger" so the first viewport immediately communicates that Mingle is a communication product rather than a generic translation utility. The hero body now anchors the category in voice conversation by saying the product creates an uninterrupted voice conversation experience across languages, which reduces ambiguity caused by putting "messenger" in the title while still preserving the voice-first use case. Share metadata was aligned with the same title and description so link previews do not contradict the first viewport.
- `2026-04-17-xr-hero-interpreter-messenger-short-title` | XR hero title was shortened from "real-time interpretation messenger" to "interpretation messenger" to reduce redundancy with the voice-conversation body copy and make the first viewport feel less feature-stacked. The update date was reformatted to an ISO-style Korean line (`최종 업데이트 - 2026-04-17`), improving scanability and avoiding mixed Korean date phrasing in the hero.
- `2026-04-17-xr-hero-language-barrier-free-voice-messenger` | XR hero title changed to "language-barrier-free voice messenger" to avoid the awkwardness of the coined "interpretation messenger" category while keeping the first viewport focused on voice communication. The body copy now names HelloTalk and Discord as comparison anchors and frames Mingle around a more comfortable conversation experience with foreigners, separating the product category from the benefit statement and reducing repetition between title and description.
- `2026-04-17-xr-appendix-after-qa` | XR deck navigation now includes a fifth table-of-contents entry for the appendix, linked to the new appendix divider slide after the first Q&A slide. The deck now ends with a duplicate Q&A/contact slide after the appendix, preserving a closing call-to-action even when appendix material is presented last.
