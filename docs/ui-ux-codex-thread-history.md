...
- 2026-04-13: Converted the XR slide about users already relying on Mingle into a two-image stack with `hellotalk-voiceroom2.png` as the back-left reference and `mingle.png` as the front-right focal image, using dedicated gaming-stack classes for independent tuning.
